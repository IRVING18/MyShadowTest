...
final public class Constant {
    ...
    public static final String KEY_OBJECT_CLASSNAME = "key_object_classname";
    ...
    public static final String PART_KEY_PLUGIN_MAIN_APP = "plugin-app";
    ...
    public static final int FROM_ID_GET_OBJECT = 1005;
